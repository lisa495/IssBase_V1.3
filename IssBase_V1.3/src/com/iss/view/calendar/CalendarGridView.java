...
public class CalendarGridView extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        LogUtil.d("Grid.onMeasure w=%s h=%s", MeasureSpec.toString(widthMeasureSpec),
                MeasureSpec.toString(heightMeasureSpec));
        int widthMeasureSize = MeasureSpec.getSize(widthMeasureSpec);
        if (oldWidthMeasureSize == widthMeasureSize) {
            LogUtil.d("SKIP Grid.onMeasure");
        ...
        LogUtil.d("Grid.onMeasure %d ms", System.currentTimeMillis() - start);
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        LogUtil.d("Grid.onLayout %d ms", System.currentTimeMillis() - start);
    }
}
