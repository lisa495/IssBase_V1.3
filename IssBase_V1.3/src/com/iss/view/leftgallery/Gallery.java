package com.iss.view.leftgallery;
...
public final class Gallery extends AbsSpinner implements GestureDetector.OnGestureListener {
    ...
    /**
     * Gets the limit of the amount to scroll the view.
     * Note: Modified from the android source to snap to the left of the view
    ...
    /**
     * Modified from getCenterOfGallery. This now gets the left of the view (plus padding).
     *
    ...
    /**
     * Looks for the child that is closest to the lock point of the gallery and sets it as the
     * selected child.
     *
     * Note: modified from setSelectionToCenterChild to now select the the selected view to the
     ...
     *
     * Note: modified to offset to the gallery lock point rather than based on the # of children.
     *
    ...
    private void updateSelectedItemMetadata() {
        ...
        // We unfocus the old child down here so the above hasFocus check returns true
